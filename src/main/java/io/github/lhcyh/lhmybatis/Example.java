 ...
 * @param <Model>
 */
public class Example<Model> extends ConditionClause<Model>{
    ...
    public Example(){
        ...
        parenthesis=new Parenthesis(getCriterionList());
    }
    ...
    public void andLeftParenthesis(){
        parenthesis.andLeftParenthesis();
    }
    ...
    public void groupBy(Model model){
        if(groupList==null){
